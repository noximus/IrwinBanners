home_animation = (function() {
	...
	function init()
	{
		...
		TweenLite.to(gripping_power, 0, {opacity:1, scaleX:2.5, scaleY:2.5});
	...
	function frame1()
	{
		...
		TweenLite.to(gripping_power, 0.2, {opacity:1, scaleX:1, scaleY:1, left:0, delay: 0.8, });		
	...
	{	
		...
		TweenLite.to(circle_tool, 0.3, {opacity:1, delay: 0.4, });		
	...
	function frame4()
	{
		...
		TweenLite.to(circle_tool, 0.2, {opacity:0, delay: 0, });		
