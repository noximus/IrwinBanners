home_animation = (function() {
	...
	function frame1()
	{
		...
		TweenLite.to(threeX, 0.9, {opacity:1, scaleX:1, scaleY:1, delay: 0.55, ease: Expo.easeOut});	
		TweenLite.to(gripping_power, 0.9, {opacity:1, scaleX:1, scaleY:1, delay: 0.55, ease: Expo.easeOut});				
	...
	function frame2()
	{
		...
		TweenLite.to(legal_line, 0.1, {opacity:0});	
	...
	{	
		...
		TweenLite.to(circle_tool, 0.6, {opacity:1, delay: 0.3, ease: Expo.easeOut});		
		TweenLite.to(four_contact, 0.5, {opacity:1, delay: 0, ease: Expo.easeOut});	
		TweenLite.to(for_maximum, 0.5, {opacity:1,  delay: 0, ease: Expo.easeOut});	
