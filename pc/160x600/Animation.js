home_animation = (function() {
	...
	{	
		...
		TweenLite.to(circle_tool, 0.6, {opacity:1, delay: 0.5, ease: Expo.easeOut});		
	...
	function frame4()
	{
		...
		TweenLite.to(circle_tool, 0.6, {opacity:0, ease: Expo.easeOut});		
		TweenLite.to(four_contact, 0.5, {opacity:0, ease: Expo.easeOut});	
		TweenLite.to(for_maximum, 0.5, {opacity:0, ease: Expo.easeOut});
