var BanTimeline = {
  ...
  init: function () {
    ...
    TweenLite.to(blurrySaw2, 0, {scaleX:1.7, scaleY:1.7});
    TweenLite.to(blurrySaw3, 0, {scaleX:1.7, scaleY:1.7});
  ...
  frame2: function () {
    TweenLite.to(bg, .5, {left:550, ease: Quad.easeInOut });
    TweenLite.to(blurrySaw2, 1.2 , {scaleX:.01, scaleY:.01,left:230,top:-10, delay: 1.2, ease: Quad.easeOut});
    TweenLite.to(blurrySaw3, 1.2 , {scaleX:.01, scaleY:.01,left:230,top:-10, delay: 1.2, ease: Quad.easeOut});
    ...
    TweenLite.to(sawCut, .5 , {top:0,left:558,opacity:1,delay: 1.7});
  ...
  frame4: function () {
    ...
    TweenLite.to(bg,.8, {left:305, display: 'block', delay: .2, ease: Quad.easeOut });
  }
};
