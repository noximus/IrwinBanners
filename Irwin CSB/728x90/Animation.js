var BanTimeline = {
  ...
  frame2: function () {
    TweenLite.to(blurrySaw2, 0 , {display:"block",opacity:1,delay: 1.2});
    TweenLite.to(blurrySaw3, 0 , {display:"block",opacity:1,delay: 1.2});

    TweenLite.to(blurrySaw2, 1.5 , {scaleX:.01, scaleY:.01,left:220,top:-35, delay: 1.2, ease: Quad.easeOut});
    TweenLite.to(blurrySaw3, 1.5 , {scaleX:.01, scaleY:.01,left:220,top:-35, delay: 1.2, ease: Quad.easeOut});
  ...
  frame3: function () {
    ...
    TweenLite.to(f4_img2, .2, {opacity:1, display: 'block', delay: 0, ease: Quad.easeInOut});
