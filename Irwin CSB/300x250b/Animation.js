var BanTimeline = {
  ...
  frame2: function () {
    ...
    TweenLite.to(blurrySaw1, 1.3, {scaleX:.01, scaleY:.01,left:-66,top:-80, delay: 1, ease: Quad.easeOut});
  ...
  frame4: function () {
    ...
    TweenLite.to(bg,.8, {left:-340, display: 'block', delay: .2, ease: Quad.easeOut});
  }
};
