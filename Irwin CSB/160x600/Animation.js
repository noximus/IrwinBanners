var BanTimeline = {
  ...
  init: function () {
    ...
    TweenLite.to(blurrySaw2, 0,{scaleX:1.5, scaleY:1.5});
    TweenLite.to(blurrySaw3, 0,{scaleX:1.5, scaleY:1.5});
    BanTimeline.frame1();
  },
  frame1: function () {  
  ...
  frame2: function () {
    ...
    TweenLite.to(blurrySaw2, 1.4, {scaleX:.01, scaleY:.01,left:-50,top:-230, delay: 1.2, ease: Quad.easeOut});
    TweenLite.to(blurrySaw3, 1.4, {scaleX:.01, scaleY:.01,left:-50,top:-230, delay: 1.2, ease: Quad.easeOut});
    ...
    TweenLite.to(sawCut, .9, {opacity:1,display:"block",top:0,left:0, delay: 1.7, ease: Quad.easeOut});
