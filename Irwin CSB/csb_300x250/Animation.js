var BanTimeline = {
  ...
  frame2: function () {
    ...
    TweenLite.to(blurrySaw3, 1.3, {scaleX:.01, scaleY:.01,left:-60,top:-75, delay: 1, ease: Quad.easeOut});
      ...
      TweenLite.to(blurrySaw2, 0, {display:"block",delay:1.3});

      TweenLite.to(blurrySaw2, 0, {display:"none",delay:1.35});
      TweenLite.to(blurrySaw3, 0, {display:"block",delay:1.35});

      TweenLite.to(blurrySaw3, 0, {display:"none",delay:1.4});
      TweenLite.to(blurrySaw2, 0, {display:"block",delay:1.4});

      TweenLite.to(blurrySaw2, 0, {display:"none",delay:1.45});
      TweenLite.to(blurrySaw3, 0, {display:"block",delay:1.45});

      TweenLite.to(blurrySaw3, 0, {display:"none",delay:1.5});
      ...
      TweenLite.to(blurrySaw2, 0, {display:"none",delay:1.65});
      TweenLite.to(blurrySaw3, 0, {display:"block",delay:1.65});

      TweenLite.to(blurrySaw3, 0, {display:"none",delay:1.7});
      TweenLite.to(blurrySaw2, 0, {display:"block",delay:1.7});

      TweenLite.to(blurrySaw2, 0, {display:"none",delay:1.75});
      TweenLite.to(blurrySaw3, 0, {display:"block",delay:1.75});
      ...
      TweenLite.to(blurrySaw2, 0, {display:"block",delay:1.9});
      ...
      TweenLite.to(blurrySaw2, 0, {display:"block",delay:2.05});
