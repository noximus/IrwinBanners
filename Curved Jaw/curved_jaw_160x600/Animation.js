home_animation = (function() {
	...
	function frame1()
	{
		...
		TweenLite.to(threeX, 0.3, {opacity:1, scaleX:1, scaleY:1, delay: 0.5});	
		TweenLite.to(gripping_power, 0.3, {opacity:1, scaleX:1, scaleY:1, delay: 0.5});				
	...
	{	
		...
		TweenLite.to(circle_tool, 0.3, {opacity:1, delay: .4, });		
	...
	function frame5()
	{
		...
		TweenLite.to(learn_more, 0.2, {opacity:1, delay: 0.4, });		
